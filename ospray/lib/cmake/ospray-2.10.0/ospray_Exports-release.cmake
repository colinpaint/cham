...
set_target_properties(ospray::ospray PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libospray.so.2.10.0"
  IMPORTED_SONAME_RELEASE "libospray.so.2"
  )

list(APPEND _IMPORT_CHECK_TARGETS ospray::ospray )
list(APPEND _IMPORT_CHECK_FILES_FOR_ospray::ospray "${_IMPORT_PREFIX}/lib/libospray.so.2.10.0" )
...
set_target_properties(ospray::ospray_module_cpu PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libospray_module_cpu.so.2.10.0"
  IMPORTED_SONAME_RELEASE "libospray_module_cpu.so.2"
  )

list(APPEND _IMPORT_CHECK_TARGETS ospray::ospray_module_cpu )
list(APPEND _IMPORT_CHECK_FILES_FOR_ospray::ospray_module_cpu "${_IMPORT_PREFIX}/lib/libospray_module_cpu.so.2.10.0" )
...
set_target_properties(ospray::ospray_module_denoiser PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libospray_module_denoiser.so.2.10.0"
  IMPORTED_SONAME_RELEASE "libospray_module_denoiser.so.2"
  )

list(APPEND _IMPORT_CHECK_TARGETS ospray::ospray_module_denoiser )
list(APPEND _IMPORT_CHECK_FILES_FOR_ospray::ospray_module_denoiser "${_IMPORT_PREFIX}/lib/libospray_module_denoiser.so.2.10.0" )
...
set_target_properties(ospray::ospray_module_mpi PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libospray_module_mpi.so.2.10.0"
  IMPORTED_SONAME_RELEASE "libospray_module_mpi.so.2"
  )

list(APPEND _IMPORT_CHECK_TARGETS ospray::ospray_module_mpi )
list(APPEND _IMPORT_CHECK_FILES_FOR_ospray::ospray_module_mpi "${_IMPORT_PREFIX}/lib/libospray_module_mpi.so.2.10.0" )
...
set_target_properties(ospray::ospray_imgui PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libospray_imgui.so.2.10.0"
  IMPORTED_SONAME_RELEASE "libospray_imgui.so.2"
  )

list(APPEND _IMPORT_CHECK_TARGETS ospray::ospray_imgui )
list(APPEND _IMPORT_CHECK_FILES_FOR_ospray::ospray_imgui "${_IMPORT_PREFIX}/lib/libospray_imgui.so.2.10.0" )
...
set_target_properties(ospray::ospray_testing PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libospray_testing.so.2.10.0"
  IMPORTED_SONAME_RELEASE "libospray_testing.so.2"
  )

list(APPEND _IMPORT_CHECK_TARGETS ospray::ospray_testing )
list(APPEND _IMPORT_CHECK_FILES_FOR_ospray::ospray_testing "${_IMPORT_PREFIX}/lib/libospray_testing.so.2.10.0" )
