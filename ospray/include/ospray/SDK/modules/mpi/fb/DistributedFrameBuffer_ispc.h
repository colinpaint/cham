//
// /builds/renderkit/ospray/build_release/modules/mpi/ospray/fb/DistributedFrameBuffer_ispc.h
...
extern "C" {
    ...
    extern float DFB_accumulateTile(const struct VaryingTile * tile, struct VaryingTile * final, struct VaryingTile * accum, struct VaryingTile * variance, bool hasAccumBuffer, bool hasVarianceBuffer);
    extern void DFB_accumulateTileSimple(const struct VaryingTile * tile, struct VaryingTile * accum, struct VaryingTile * variance);
    extern float DFB_computeErrorForTile(const struct vec2i &size, const struct VaryingTile * accum, const struct VaryingTile * variance, const float accumID);
    extern void DFB_runPixelOpsForTile(void * _self, void * _tile);
    extern void DFB_sortAndBlendFragments(struct VaryingTile *  * tileArray, int32_t numTiles);
    extern void DFB_writeTile_RGBA32F(const struct VaryingTile * tile, void * _color);
    extern void DFB_writeTile_RGBA8(const struct VaryingTile * tile, void * _color);
    extern void DFB_writeTile_SRGBA(const struct VaryingTile * tile, void * _color);
