//
// /builds/renderkit/ospray/build_release/modules/cpu/fb/LocalFB_ispc.h
...
extern "C" {
    ...
    extern void LocalFrameBuffer_writeAuxTile(void * _fb, const void * _tile, struct vec3f * aux, const void * _ax, const void * _ay, const void * _az);
